...
//-----------------------------------------------------------------
class timetrackerTools extends \Contao\Backend
{
	...
	{                                                                                                             
		...
		$GLOBALS['TIMETRACKER']['VERSION'] = \Contao\System::getContainer()->getParameter('kernel.packages')['do-while/contao-timetracker-bundle'];
